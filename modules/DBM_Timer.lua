...
local function registerBWStyle()
    ...
    local backdropBorder = {
        bgFile = [[Interface\AddOns\ShredzUI\media\Plain]],
        edgeFile = [[Interface\AddOns\ShredzUI\media\Plain]],
    ...
    local function styleBar(bar)
        ...
        bar:SetTexture([[Interface\AddOns\ShredzUI\media\Plain]])
    end
...
local function registerDBMStyle()
    ...
    skin.defaults = {
        ...
        Texture = [[Interface\AddOns\ShredzUI\media\Plain]],
        FillUpBars = false,
        IconLocked = false,
